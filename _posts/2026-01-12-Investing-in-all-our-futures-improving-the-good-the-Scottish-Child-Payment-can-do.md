---
layout: post
title: "Investing in all our futures: improving the good the Scottish Child Payment can do"
author: "Ilona Pinter, Charlotte Zealley, Lily Gordon Brown, Maria Marshall and Changing Realities participants."
...
<div class="info-box">
  ...
  <ul class="info-links">
    {% for link in site.data.info-links %}
      <li><i class="fa-solid fa-download"> </i><a  href="assets/pdf/Scottish Child Payment Briefing January 2026.pdf" target="_blank" rel="noopener noreferrer">Read and download</a></li>
    {% endfor %}
  </ul>
</div>
