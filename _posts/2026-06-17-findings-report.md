...
<div class="pdf-container">
  <iframe
    src="{{ '/assets/pdf/family-finances-findings-report.pdf' | relative_url }}"
    title="Family Finances findings report"
    width="100%"
    height="800">
  </iframe>
</div>
...
<p>
  <a
    class="button"
    href="{{ '/assets/pdf/family-finances-findings-report.pdf' | relative_url }}"
    target="_blank"
    rel="noopener">
