...
<div class="pdf-container">
  <iframe
    src="{{ '/assets/pdf/family-finances-policy-brief.pdf' | relative_url }}"
    title="Family Finances policy briefing"
    width="100%"
    height="800">
  </iframe>
</div>
...
<p>
  <a
    class="button"
    href="{{ '/assets/pdf/family-finances-policy-brief.pdf' | relative_url }}"
    target="_blank"
    rel="noopener">
